...
input_arg = list(map(convert, "agar chatur_vedii muhaavara wakt san.saar kaise chaan.d an.gur rajaa_i rajai in.saan kya nikhil paanDey rajoguN abhivyaktii imaan_daar kat_i khaa_ii nihaaytii aa_ii".split(" ")))
